...
Usage::
    ...
    conda run -n vnpy43 python myQuant/news_ingestion/scripts/fetch_news.py \\
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    source_map = {"eastmoney": Source.EASTMONEY, "cninfo": Source.CNINFO, "cls_telegraph": Source.CLS_TELEGRAPH, "sina_finance": Source.SINA_FINANCE}
