...
| Item | Value |
|------|-------|
| Script | `myQuant/news_ingestion/scripts/fetch_news.py` |
...
| Item | Value |
|------|-------|
| Script | `myQuant/news_ingestion/scripts/evaluate_news.py` |
...
| Item | Value |
|------|-------|
| Script | `myQuant/news_ingestion/scripts/generate_daily_signals.py` |
